import { Home, Airplay, Box, PlusSquare,FolderPlus, Command, Cloud, FileText, Server, BarChart, Users, Layers, ShoppingBag, List, Mail, MessageCircle, GitPullRequest, Monitor, Heart, Clock, Zap, CheckSquare, Calendar, Image, Film, HelpCircle, Radio, Map, Edit, Sunrise, Package, Folder } from 'react-feather'
export const MENUITEMS = [
    {
        ...
        Items:[
            ...
            //     title: 'Dashboard', icon: Home, type: 'sub',badge: "badge badge-success",badgetxt:"2", active: false, children: [
                //     { path: `${process.env.PUBLIC_URL}/dashboard/default`,icon: Home,title: 'Dashboard Home', type: 'link' },
                    { path: `${process.env.PUBLIC_URL}/dashboard`, icon: Home ,title: 'Dashboard Home', type: 'link' },
            //     ]
            // },
    //         {
    ...
    //         { path: `${process.env.PUBLIC_URL}/app/knowledgebase`,icon: Sunrise,  type: 'link',active:false,title: 'Knowledgebase' },
            { path: `${process.env.PUBLIC_URL}/app/ticket-classification`,icon: Folder,  type: 'link', active:false,title: 'Ticket Classification' },
            // { path: `${process.env.PUBLIC_URL}/app/manage-users`,icon: Users,  type: 'link', active:false,title: 'Manage Users' },
            { path: `${process.env.PUBLIC_URL}/app/live-ticket-prediction`,icon: Box,  type: 'link', active:false,title: 'Live Ticket Prediction' },
    ]   
    },
]